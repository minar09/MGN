...
path = '/media/minar/Galaxy/Datasets/Multi-Garment_dataset/'
all_scans = glob(path + '*')
...
def visualize_garment(garment_path, with_tex=True):
    ...
    dat['gender'] = 'neutral'
    garment_posed = pose_garment(
        garment_unposed, vert_indices[garment_type], dat)
    garment_posed = remove_interpenetration_fast(
        garment_posed, garment_org_body)
...
if __name__ == '__main__':
    ...
    # This file contains correspondences between garment vertices and smpl body
